...
def procesar_imagen(ruta):
    ...
    return volume3d, axial_aspect_ratio, sagital_aspect_ratio, coronal_aspect_ratio, img_shape, total_frames

def generar_imagen(tipo, ruta, frame_index, return_bytesio=False):
    volume3d, axial_aspect_ratio, sagital_aspect_ratio, coronal_aspect_ratio, i_s, _ = procesar_imagen(ruta)
...
def seleccionar_imagen():
    ...
    _, _, _, _, _, total_frames = procesar_imagen(ruta)
...
def ajustar_contraste_imagen():
    ...
    output = generar_imagen(tipo, ruta, frame_index, return_bytesio=True)
